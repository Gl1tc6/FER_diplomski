...
def red_uncle_case(
    ...
    # nastavi sa rebalansiranjem
    if grandparent.parent:
        is_left = grandparent is grandparent.parent.left
        tree.insert_rebalance(grandparent, is_left)
...
def straight_case(
    ...
    rotation_type = RotationType.Right if parent is grandparent.left else RotationType.Left
    tree.swap_colors(parent, grandparent)
    tree.rotate(grandparent, parent, rotation_type)
...
def broken_case(
    ...
    rotation_type = RotationType.Right if node is parent.left else RotationType.Left
    tree.rotate(parent, node, rotation_type)
    straight_case(tree, parent, node, uncle, grandparent)